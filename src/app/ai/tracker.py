    ...
    def update(self, detections: List[Dict[str, Any]], timestamp: Optional[float] = None) -> Dict[int, Track]:
        ...
        for det in detections:
            ...
            if best_iou >= self.iou_thresh and best_tid is not None:
                ...
                # Smooth bbox transitions using exponential moving average (EMA)
                # This reduces jittery box movement while staying responsive
                ...
                tr.bbox = smoothed_bbox  # Use smoothed position
